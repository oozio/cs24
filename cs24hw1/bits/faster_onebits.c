...
//This function uses the expression given in the assignment to reduce the number of 1's in n's binary representation, incrementing a counter each time, until n is 0. 
