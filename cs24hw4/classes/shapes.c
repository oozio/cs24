...
Box_Data * new_Box(float L, float W, float H, float D) {
    /* TODO */
    Box_Data *box = malloc(sizeof(*box)); 
...
Sphere_Data * new_Sphere(float R, float D) {
    /* TODO */
    Sphere_Data *sphere = malloc(sizeof(*sphere));
...
Cone_Data * new_Cone(float BR, float H, float D) {
    /* TODO */
    Cone_Data *cone = malloc(sizeof(*cone));
...
float Cone_getVolume(Cone_Data *this) {
    /* TODO */
    return 3.14159 * (1.0 / 3.0) * this->base_radius * this->base_radius * this->height;
}
